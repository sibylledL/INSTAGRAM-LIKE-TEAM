$(function() {
  ...
  closeBtn.click(function() {
    $("#nouvelleFenetre-1").css("display", "none")
    $("#nouvelleFenetre-2").css("display", "none")
    $("#nouvelleFenetre-3").css("display", "none")
    $("#nouvelleFenetre-4").css("display", "none")
    $("#nouvelleFenetre-5").css("display", "none")
    $("#nouvelleFenetre-6").css("display", "none")
    $("#nouvelleFenetre-7").css("display", "none")
    $("#nouvelleFenetre-8").css("display", "none")
    $("#nouvelleFenetre-9").css("display", "none")
    $("#nouvelleFenetre-10").css("display", "none")
    $("#nouvelleFenetre-11").css("display", "none")
    $("#nouvelleFenetre-12").css("display", "none")
    $("#nouvelleFenetre-13").css("display", "none")
    $("#nouvelleFenetre-14").css("display", "none")
    $("#nouvelleFenetre-15").css("display", "none")
  })

  $(document).click(function(e) {
    if ((e.target.id == "nouvelleFenetre-1") || (e.target.id == "nouvelleFenetre-2") || (e.target.id == "nouvelleFenetre-3") ||
      (e.target.id == "nouvelleFenetre-4") || (e.target.id == "nouvelleFenetre-5") ||
      (e.target.id == "nouvelleFenetre-6") || (e.target.id == "nouvelleFenetre-7") ||
      (e.target.id == "nouvelleFenetre-8") || (e.target.id == "nouvelleFenetre-9") ||
      (e.target.id == "nouvelleFenetre-10") || (e.target.id == "nouvelleFenetre-11") ||
      (e.target.id == "nouvelleFenetre-12") || (e.target.id == "nouvelleFenetre-13") ||
      (e.target.id == "nouvelleFenetre-14") || (e.target.id == "nouvelleFenetre-15")) {
      $("#nouvelleFenetre-1").css("display", "none")
      $("#nouvelleFenetre-2").css("display", "none")
      $("#nouvelleFenetre-3").css("display", "none")
      $("#nouvelleFenetre-4").css("display", "none")
